...
//Orthonormalizes DGRAD wrt to DVEC
#define DG_ROT 1
#define UPDATE_BP 0
...
//  ofstream xyzfile;
 ...
 // double* pgrad;
  ...
  int grad_to_q();
	int dgrad_to_q(double* dgrad,double* dgradq);
	double project_gradq(double* gradq,double* gradq_U);
	void constrain_gradq(double* gradq_U);
	void constrain_bp(double* dgradq_U,double* dvecq_U);
	double dgrot_mag(double* dgradq,double* dvecq);
	void dc_rot(double* dgradq,double* dvecq);
	void update_dvec(double* dvecq,double* dgradq,double* dgrad);
  int ic_to_xyz();
  int ic_to_xyz_opt();
//  int qchem_init(string infilename, int ncpu, int run, int rune);
  ...
  double opt_c(string xyzfile_string, int nsteps, double* C, double* C0);
	double opt_D(string xyzfile_string, int nsteps,int n, double* dgrad, double* dgradq, double* dgradq_U, double* dvec, double* dvecq,double* dvecq_U,double* grads);
...
// help functions for iso
  ...
  void print_ic();
  void print_bonds();
	void print_tangent(string xyzfile_string,double* coords,double* coordsp);
	void print_dgrad_save(string xyzfile_string,double* coords, double* dgrad);
  void print_xyz();
