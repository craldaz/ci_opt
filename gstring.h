...
class GString {
 private:
  ...
  void growth_iters(int max_iter, double& totalgrad, double& gradrms, double endenergy, string strfileg, int& tscontinue, double gaddmax, int osteps, int oesteps, double** dqa, double* dqmaga, double** ictan, double** dgrada, double** dgradqa, double** dgradqa_U,double** dveca,double** dvecqa,double** dvecqa_U,double** grads);
...
//  string comment;		//comment line of first structure read
  ...
  void starting_string(double* dq, int nnodes);
	void starting_dstring(int nnodes, double** dqa, double* dqmaga,double** dgrada, double** dgradqa,double** dgradqa_U,double** dveca,double** dvecqa,double** dvecqa_U,double** grads);
  void starting_string_dm(double* dq);
  int addNode(int n1, int n2, int n3);
	int addDNode(int n1,int n2,int n3,double** dqa, double* dqmaga,double** dgrada, double** dgradqa,double** dgradqa_U,double** dveca,double** dvecqa,double** dvecqa_U,double** grads);
  int addCNode(int n1);
  ...
  void opt_steps(double** dqa, double** ictan, int osteps, int oesteps);
	void opt_steps_d(double** dgrada, double** dgradqa, double** dgradqa_U, double** dveca, double** dvecqa, double** dvecqa_U, int osteps,double** grads);
  ...
  void tangent_1(double* ictan);
	void calc_dgradq(double* dgrad, double* dgradq,int run,int rune);
  ...
  void get_tangents_1gh(double** dqa, double* dqmaga, double** ictan,double** dgrada,double** dgradqa,double** dgradqa_U);
